...
# CSS Global: Ajusta fundo dark e texto branco para praticamente toda a dashboard,
# incluindo sidebar, inputs, file uploader, notificações e demais componentes.
st.markdown("""
    <style>
    /* ========= REGRAS GLOBAIS ========= */
