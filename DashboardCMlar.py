...
# Upload do arquivo Excel (que contém as colunas definidas)
uploaded_file = st.sidebar.file_uploader("📥 Importar arquivo Excel", type=["xlsx"])

# Lógica para carregar e/ou manter o DataFrame na sessão
...
if df is not None:
    ...
    # 2) Filtro por GrupoDeConta (opcional)
    ...
    total_saidas_abs = abs(total_saidas)  # para exibir positivo
    # Saldo
    ...
    with tab3:
        ...
        df_saidas_mensal['Valor'] = df_saidas_mensal['Valor'].abs()  # para exibir positivo
