...
# CSS Global para fundo dark e texto claro, inclusive na sidebar e inputs
st.markdown("""
    <style>
    /* ================================================
       1) REGRAS GLOBAIS: FUNDO ESCURO E TEXTO CLARO
       ================================================ */
    html, body, [data-testid="stAppViewContainer"] {
        background-color: #2d2d2d !important; /* fundo escuro principal */
        color: #ffffff !important;           /* texto branco */
        font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
    }
    /* Força texto branco em praticamente tudo */
    html, body, [data-testid="stAppViewContainer"] * {
    ...
    /* ================================================
       2) FILE UPLOADER: FUNDO ESCURO E TEXTO CLARO
       ================================================ */
    [data-testid="stFileUploader"] {
        background-color: #1a1a1a !important; /* fundo do uploader */
    ...
    /* ================================================
       3) INPUTS E DATE INPUT (CALENDÁRIO)
       ================================================ */
    /* Campos de texto */
    ...
    /* Ajuste para datepicker do BaseWeb (se necessário) */
    ...
    /* ================================================
       ...
       ================================================ */
    /* Tabelas: forçamos fundo escuro e texto claro no thead/tbody */
    table, th, td {
        border-color: #444444 !important;
    }
    /* Ajuste adicional via pandas Styler iremos fazer manualmente */
    </style>
